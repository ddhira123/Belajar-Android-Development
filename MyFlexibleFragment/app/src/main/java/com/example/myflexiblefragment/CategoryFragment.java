...
public class CategoryFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_detail_category){
            CategoryDetailFragment mCategoryDetailFragment = new CategoryDetailFragment();
            Bundle mBundle = new Bundle();
            mBundle.putString(CategoryDetailFragment.EXTRA_NAME, "Lifestyle");
            String description = "Kategori ini akan berisi produk-produk lifestyle";
            mCategoryDetailFragment.setArguments(mBundle);
            mCategoryDetailFragment.setDescription(description);
            ...
            if (mFragmentManager != null) {
                mFragmentManager
                        .beginTransaction()
                        .replace(R.id.frame_container, mCategoryDetailFragment, CategoryDetailFragment.class.getSimpleName())
                        .addToBackStack(null)
                        .commit();
            }
        }

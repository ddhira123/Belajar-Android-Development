...
public class CategoryFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // OnClickListener tanpa SAFE ARGS
...
//        });
        ...
        // OnClickListener dengan SAFE ARGS
        btnCategoryLifestyle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                CategoryFragmentDirections.ActionCategoryFragmentToDetailCategoryFragment toDetailCategoryFragment = (CategoryFragmentDirections.ActionCategoryFragmentToDetailCategoryFragment) CategoryFragmentDirections.actionCategoryFragmentToDetailCategoryFragment();

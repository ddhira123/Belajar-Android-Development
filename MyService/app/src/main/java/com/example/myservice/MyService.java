...
/**
 * Langkah-langkah menjalankan servis sederhana:
 * 1. Buat interface {@link DummyAsyncCallback}
 * 2. Implement interface tsb di class service terkait {@link MyService}
 * 3. Buat inner-class {@link DummyAsync} yang menggunakan {@link AsyncTask} dan {@link WeakReference}
 * 4. Inisialisasi dan Jalankan AsyncTask {@link #onStartCommand}
 * 5. Tambahkan aksi di callbacks {@link #preAsync()} dan {@link #postAsync()}
 */
